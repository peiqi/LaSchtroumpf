...
from neutron.tests.unit.extensions.test_agent import AgentDBTestMixIn
from oslo_log import log as logging

LOG = logging.getLogger(__name__)

DB_PLUGIN_KLASS = ('neutron.tests.unit.extensions.test_qos.'
                   'QoSTestPlugin')
...
class QoSTestCase(AgentDBTestMixIn,
